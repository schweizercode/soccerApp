                        ...
                        <div>
                            ...
                            {team &&
                                <Card style={flexitemcardstyle}>
                                    ...
                                    <div >
                                        <Card style={{ backgroundColor: 'rgba(68, 66, 64, 0.09)', padding: '2%', textAlign: 'left', marginTop: '%' }} >
                                        ...
                                        <div className="card mt-4 mb-3" style={{ alignItems: 'center' }}>
                                            ...
                                            <div className="card-body">
                                                <textarea rowsMax={4}
                                                    ...
                                                    placeholder="Maximum 4 rows" name="comment" className="from-control" placehodler='Add a new comment'
