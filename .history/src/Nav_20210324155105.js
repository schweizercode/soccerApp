        ...
        <nav>
            <ReactBootStrap.Navbar collapseOnSelect expand="lg" bg="dark" variant="dark" style={{ paddingLeft: '3%', }}>
                ...
                <ReactBootStrap.Navbar.Collapse id="responsive-navbar-nav">
                    ...
                    <ReactBootStrap.Nav className="mr-auto" style={{ paddingLeft: '1%', fontSize: '13px' }}>
                        {currentUser && <ReactBootStrap.Nav.Link href="/profile">Loged in as:{currentUser.email}</ReactBootStrap.Nav.Link>}
                    </ReactBootStrap.Nav>
